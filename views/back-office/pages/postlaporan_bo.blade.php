...
<div class="section-header">
  ...
  <div class="section-header-button">
    <a href="{{route('post-laporan-create')}}" class="btn btn-primary">Tambah Baru</a>
  </div>  
</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-striped" id="table_post_laporan">
              <thead>
                <tr>
...
$(document).ready(function() {
  var table = $('#table_post_laporan').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ url('bo/json/post-laporan') }}',
      columnDefs: [
          {
              "targets": [ 0 ],
              "data": null,
  ...
  $('#table_post_laporan tbody').on('click', 'button.details-data', function () {
  ...
  $('#table_post_laporan tbody').on('click', '.hard-delete-confirm', function (event) {
  ...
  $('#table_post_laporan tbody').on('click', '.soft-delete-confirm', function (event) {
      event.preventDefault();
      const url = $(this).attr('href');
      swal({
          title: 'Apakah anda yakin.?',
