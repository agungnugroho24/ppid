...
<div class="section-header">
  ...
  <div class="section-header-button">
    <a href="{{route('informasi-front-office-adm-create')}}" class="btn btn-primary">Tambah Baru</a>
  </div>  
</div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-striped" id="table_informasifrontoffice">
              <thead>
                <tr>
...
$(document).ready(function() {
  var table = $('#table_informasifrontoffice').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ url('bo/json/informasi-front-office') }}',
      columnDefs: [
          {
              "targets": [ 0 ],
              "data": null,
  ...
  $('#table_informasifrontoffice tbody').on('mouseover','td.cell-button-publish',function(){
    $('[data-toggle="tooltip"]').tooltip();
  }); 

  $('#table_informasifrontoffice tbody').on('mouseover','td.cell-button-update',function(){
    $('[data-toggle="tooltip"]').tooltip();
  }); 

  $('#table_informasifrontoffice tbody').on('mouseover','td.cell-button-delete',function(){
    $('[data-toggle="tooltip"]').tooltip();
  });       

  //Add event listener for opening and closing details
  $('#table_informasifrontoffice tbody').on('click', 'button.details-data', function () {
  ...
  $('#table_informasifrontoffice tbody').on('click', '.hard-delete-confirm', function (event) {
  ...
  $('#table_informasifrontoffice tbody').on('click', '.soft-delete-confirm', function (event) {
      event.preventDefault();
      const url = $(this).attr('href');
      swal({
          title: 'Apakah anda yakin.?',
