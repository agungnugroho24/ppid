...
<div class="section-body">
  <h2 class="section-title">Buat Post Konten Kunjungan Tamu</h2>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4>Form Post Konten Kunjungan Tamu</h4>
        </div>
          ...
          @endif 
        <div class="card-body">
          <form id="form-post-content" action="{{ route('post-kunjungan-tamu') }}" method="POST" enctype="multipart/form-data">
            @csrf          
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <select class="form-control selectric @error('kategori') is-invalid @enderror" id="kategori" name="kategori">
                  ...
                  <option value="tata cara">Tata Cara</option>
                </select>
                @error('kategori')
                    <div class="alert alert-danger alert-block small">
                      <strong>{{ $message }}</strong>
