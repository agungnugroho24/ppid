...
<div class="section-header">
  <div class="section-header-back">
    <a href="{{route('permission-user-adm')}}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
  </div>
  <h1>Kembali Ke Halaman Pengolahan Permission Pengguna Aplikasi PPID</h1> 
</div>

<div class="section-body">
  <h2 class="section-title">Edit Data Permission Pengguna Aplikasi PPID</h2>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4>Form Edit Data Permission Pengguna Aplikasi PPID</h4>
        </div>
          ...
          @endif          
        <div class="card-body">
          <form id="form-post-content" action="{{ route('permission-user-adm-update',  $data[0]->id) }}" method="POST" enctype="multipart/form-data">
            @csrf          
            @method('PUT')          
            <div class="form-group row mb-4">
              <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Permission</label>
              <div class="col-sm-12 col-md-7">
                <input type="text" id="permission" name="permission" class="form-control @error('permission') is-invalid @enderror" value="{{ $data[0]->name }}" disabled>
                @error('permission')
