        ...
        @if (Route::has('login'))
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarRequest">
              <a class="dropdown-item" href="{{ route('informasi-publik') }}" style="color:#165a64;">Permohonan Informasi dan Dokumentasi</a>               
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarTracking">
              <a class="dropdown-item" href="{{ route('informasi-publik-progres') }}" style="color:#165a64;">Progres Permohonan Informasi dan Dokumentasi</a>  
