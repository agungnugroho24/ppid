        ...
        <div class="container ">
          ...
          <div class="row">              
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  <a href="https://api.whatsapp.com/send/?phone=6281211002143&text&app_absent=0" target="_blank"><i class="fab fa-whatsapp" style="border: 1px solid #ffffff"></i></a>
                  <p style="color:#ffffff;">
                    @isset($kontak)
                      @foreach($kontak as $data)
                        @if($data->nama == 'Kontak Telepon')
                          <a href="https://api.whatsapp.com/send/?phone=6281211002143&text&app_absent=0" target="_blank">{{ $data->data }} </a>
                        @endif
                      @endforeach
                    @endisset                     
                      <br>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  <i class="fa fa-envelope-o" style="border: 1px solid #ffffff"></i>
                  <p style="color:#ffffff;">
                    @isset($kontak)
                      @foreach($kontak as $data)
                        @if($data->nama == 'Email')
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              <div class="contact-icon text-center">
                <div class="single-icon">
                  <a href="https://goo.gl/maps/UQbFiqnvxU583hm16" target="_blank"><i class="fa fa-map-marker" style="border: 1px solid #ffffff"></i> </a>
                  <p style="color:#ffffff;">
                    @isset($kontak)
                      @foreach($kontak as $data)
                        @if($data->nama == 'Alamat')
