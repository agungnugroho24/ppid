...
@section('title', 'Halaman Progres Permintaan Informasi Publik')
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-header">{{ __('Progres Permintaan Informasi Publik') }}</div>
...
$(document).ready(function() {
  var table = $('#table-data-permintaan-informasi').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ url('bo/json/permintaan-informasi-progres') }}',
      columnDefs: [
          {
              "targets": [ 0 ],
              "data": null,
          ...
          },         
          {
              ...
              "visible": true,
              "searchable": true,
              "className": 'dt-center cell-statuspermintaan',
              "render": function(data){
                  var statuspermintaan = "<span class='small font-weight-bold'>Permohonan&nbsp;"+data+"</span>";
                  if(data == "Menunggu approval"){
                    var textdata = data.split(" ").join('&nbsp;');
                    return "<span class='small font-weight-bold'>"+textdata+"</span>";
                  }
                  if(data == "Permohonan diterima"){
                    return "<span class='small font-weight-bold'>"+data+"</span>";
                  }                  
