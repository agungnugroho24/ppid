...
@section('title', 'SOP PPID Kementerian PPN/Bappenas')
              ...
              <div class="single-well">
                ...
                <div class="card mb-4 card-ppid-custom" style="border:none;">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{ route('show-sop', $row->uuid_code) }}" target="_blank" class="btn btn-outline-secondary float-right" style="padding: 6px 18px 6px 18px;font-size: 14px;border-radius:20px;">Baca lebih lanjut &nbsp;<i class="fa fa-angle-double-right"></i></a>
                  </div>
                </div>
                @endforeach
                @endisset
