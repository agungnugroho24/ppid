...
@section('title', 'Halaman Progres Permohonan Kunjungan')
    ...
    <div id="services" class="services-area area-padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">{{ __('Progres Permohonan Kunjungan') }}</div>
...
$(document).ready(function() {
  var table = $('#table-data-permintaan-informasi').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ url('bo/json/permohonan-kunjungan-progres') }}',
      columnDefs: [
          {
              "targets": [ 0 ],
              "data": null,
