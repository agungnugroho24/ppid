...
@section('title', 'Tentang PPID Kementerian PPN/Bappenas')
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-12">
                          {!! $row->konten_pendek !!}
                          <div class="mt-3">
                            <a href="{{ route('show-informasisetiapsaat', $row->uuid_code) }}" target="_blank" class="btn btn-sm btn-outline-secondary float-right" style="padding: 6px 18px 6px 18px;font-size: 14px;border-radius:20px;">Baca lebih lanjut &nbsp;<i class="fa fa-angle-double-right"></i></a>                            
                          </div>                          
                        </div>
                      </div>
                    </div>
